...
alias du='du -h'
alias ssh='ssh -Y'
alias sshbram='ssh bram@rpi562.home -p 12345'
alias sshiot='ssh bram@rpi578933.home -p 12345'
alias bitbram='git pull https://brammieboy12@bitbucket.org/brammieboy12/ops-semester-3.git'
